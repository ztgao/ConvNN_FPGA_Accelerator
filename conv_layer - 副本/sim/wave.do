...
add wave -noupdate -expand -group Network /tb_top/U_network_manager/clk
add wave -noupdate -expand -group Network /tb_top/U_network_manager/rst_n
add wave -noupdate -expand -group Network /tb_top/U_network_manager/start
add wave -noupdate -expand -group Network /tb_top/U_network_manager/layer_0_calc_fin
add wave -noupdate -expand -group Network /tb_top/U_network_manager/data_out
add wave -noupdate -expand -group Network /tb_top/U_network_manager/layer_0_en
add wave -noupdate -expand -group Network -radix unsigned /tb_top/U_network_manager/input_image_idx
add wave -noupdate -expand -group Network /tb_top/U_network_manager/lastImage
...
add wave -noupdate -expand -group ctrl -radix unsigned /tb_top/U_conv_layer_top_0/U_conv_layer_controller_0/preload_cycle
...
add wave -noupdate -expand -group ctrl /tb_top/U_conv_layer_top_0/U_conv_layer_controller_0/lastRow
add wave -noupdate -expand -group ctrl /tb_top/U_conv_layer_top_0/U_conv_layer_controller_0/lastPreloadCycle
add wave -noupdate -expand -group ctrl /tb_top/U_conv_layer_top_0/U_conv_layer_controller_0/lastWeight
...
add wave -noupdate -expand -group conv_input_buffer /tb_top/U_conv_layer_top_0/U_conv_layer_input_interface_0/U_conv_layer_input_buffer_0/buffer_array_ob_0
add wave -noupdate -expand -group conv_input_buffer /tb_top/U_conv_layer_top_0/U_conv_layer_input_interface_0/U_conv_layer_input_buffer_0/buffer_array_ob_1
add wave -noupdate -expand -group conv_input_buffer /tb_top/U_conv_layer_top_0/U_conv_layer_input_interface_0/U_conv_layer_input_buffer_0/buffer_array_ob_2
